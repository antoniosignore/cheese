...
public final class PatternFactory
{
    ...
    private void parseCandelstick(Node root)
        throws ParserConfigurationException
    {
    ...
    private Constraint parseTrend(Node constraintNode)
        throws ParserConfigurationException
    {
        ...
        if(0 == "sma".compareToIgnoreCase(curve))
        {
    ...
    private Constraint parseConstraint(Node constraintNode)
        throws ParserConfigurationException
    {
    ...
    private Scalar parseUnit(String unit)
        throws ParserConfigurationException
    {
    ...
    private Scalar parseTolerance(String tolerance)
        throws ParserConfigurationException
    {
    ...
    private Scalar parseConst(Node scalarNode)
        throws ParserConfigurationException
    {
        int index = getIndex();
    ...
    private Collection parseScalar(Node scalarNode)
        throws ParserConfigurationException
    {
