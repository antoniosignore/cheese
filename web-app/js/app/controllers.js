...
phonecatControllers.controller('BookListCtrl', ['$scope', '$rootScope', '$http', '$location', 'apiUrl', function ($scope, $rootScope, $http, $location, apiUrl) {
    var load = function () {
...
phonecatControllers.controller('NewBookCtrl', ['$scope', '$rootScope', '$http', '$location', 'apiUrl', function ($scope, $rootScope, $http, $location, apiUrl) {
...
phonecatControllers.controller('EditBookCtrl', ['$scope', '$rootScope', '$http', '$location', 'apiUrl', function ($scope, $rootScope, $http, $routeParams, $location, apiUrl) {
