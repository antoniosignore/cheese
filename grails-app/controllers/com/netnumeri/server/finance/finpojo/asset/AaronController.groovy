...
class AaronController {
    ...
    def indicator() {
        ...
        stockInstance.indicators.put("aarondown", new AaronDownOverPeriodIndicator(stockInstance, "Aaron Down Over Period Indicator", 10))
        stockInstance.indicators.put("aaronup", new AaronUpOverPeriodIndicator(stockInstance, "Aaron Up Over Period Indicator", 10))
        stockInstance.indicators.put("aaronosc", new AaronOscillatorOverPeriodIndicator(stockInstance, "AaronOscillatorOverPeriodIndicator", 10))
