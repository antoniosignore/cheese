...
class BootStrap {
    ...
    String recognition
            ...
            new Pattern(code: 1007, name: "BULLISH INVERTED HAMMER",
                    ...
                    noSticks: 2,
                    definition: "Bullish Inverted Hammer Pattern is a candlestick characterized by a long upper shadow and a small real body preceded by a long black real body. It is similar in shape to the Bearish Shooting Star. The shooting star appears in a downtrend and thus it becomes a potentially bullish inverted hammer.",
                    recognition: "1. Market is currently characterized by downtrend.\n" +
                            ...
                            "7. The second body does not have lower shadow or it has only a very little lower shadow.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1008, name: "BULLISH ABANDONED BABY",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. Then we see a white candlestick on the third day with a gap in the opposite direction with no overlapping shadows.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1009, name: "BULLISH PIERCING LINE",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 2,
                    definition: "Bullish Piercing Line Pattern is a bottom reversal pattern. A long black candlestick is followed by a gap lower during the next day while the market is in downtrend. The day ends up as a strong white candlestick, which closes more than halfway into the prior black candlestick’s real body.",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "5. The second day however fails to close above the body of the first day.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1010, name: "BULLISH HARAMI",
                    ...
                    noSticks: 2,
                    definition: "Bullish Harami Pattern is characterized by a small white real body contained within a prior relatively long black real body. “Harami” is an old Japanese word for “pregnant”. The long black candlestick is “the mother” and the small candlestick is “the baby”.",
                    recognition: "1. The market is in a bearish mood characterized by downtrend.\n" +
                            "2. Then we see a long black candlestick.\n" +
                            "3. We see a white candlestick on the following day where the small white real body is completely engulfed by the real body of the first day. The shadows (high/low) of the second candlestick are not necessarily contained within the first body, however it's preferable if they are.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1011, name: "BULLISH UPSIDE GAP THREE METHODS",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks:3,
                    definition: "The pattern is characterized by two long white candlesticks with a gap upward between them during an uptrend. The third day is a black candlestick, which closes the gap between the first two. A support for uptrend may be forming caused by temporary profit taking.",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "4. The third black candlestick fills the gap between the first two days.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1012, name: "WHITE MARUBOZU",
                    ...
                    confirmation: ConfirmationTypeEnum.Required,
                    noSticks: 1,
                    definition: "The White Marubozu is a single candlestick pattern characterized with a long white body having no shadows on either end. It is an extremely strong bullish candlestick pattern.",
                    recognition: "1. A white Marubozu does not have upper or lower shadows.\n" +
                            ...
                            "3. The day also closes at the high of the day and hence with no upper shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1013, name: "BEARISH ENGULFING",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 2,
                    definition: "Bearish Engulfing Pattern is a large black real body, which engulfs a small white real body in an uptrend (it need not engulf the shadows). The Bearish Engulfing Pattern is an important top reversal signal",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a white candlestick in the first day.\n" +
                            "3. Then we see a black candlestick that completely engulfs the real body of the first day.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1014, name: "BEARISH HANGING MAN",
                    ...
                    confirmation: ConfirmationTypeEnum.DefinitelyRequired,
                    noSticks: 1,
                    definition: "The Bearish Hanging Man Pattern is a single candlestick and a top reversal pattern. It is very similar to the Bearish Dragonfly Doji Pattern. In case of the Bearish Dragonfly Doji Pattern, the opening and closing prices are identical whereas the Bearish Hanging Man Pattern has a small real body",
                    recognition: "1. We see it at a market top or during an uptrend.\n" +
                            ...
                            "4. There is either no upper shadow or a very short upper shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1015, name: "BEARISH SHOOTING STAR",
                    ...
                    confirmation: ConfirmationTypeEnum.DefinitelyRequired,
                    noSticks: 2,
                    definition: "Bearish Shooting Star Pattern suggests that prices may be approaching to a top. It looks like its name, a shooting star. The shooting star is a small real body characterized by a long upper shadow, which gaps away from the prior real body",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a white candlestick in the first day.\n" +
                            ...
                            "5. However; second day pattern has no (or close to none) lower shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1016, name: "BEARISH ABANDONED BABY",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bearish Abandoned Baby Pattern is a very rare top reversal signal. It is basically composed of a Doji Star, which shows gaps (including shadows) from the prior and following sessions’ candlesticks",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a long white candlestick in the first day.\n" +
                            ...
                            "4. Finally we see a black candlestick characterized with a gap in the opposite direction, with no overlapping shadows.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1017, name: "BEARISH DARK CLOUD COVER",
                    ...
                    recognition: "1. Market is characterized by an uptrend.\n" +
                            ...
                            "4. The second black candlestick closes within and below the midpoint of the previous white body").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1018, name: "BEARISH HARAMI",
                    ...
                    confirmation: ConfirmationTypeEnum.StronglySuggested,
                    noSticks: 2,
                    definition: "Bearish Harami Pattern is a two-candlestick pattern composed of a small black real body contained within a prior relatively long white real body. “Harami” is an old Japanese word for “pregnant”. The long white candlestick is “the mother” and the small candlestick is “the baby”",
                    recognition: "1. Market is characterized by an uptrend.\n" +
                            "2. We see a long white candlestick on the first day.\n" +
                            "3. Then we see a black candlestick on the second day whose real body is completely engulfed by the real body of the first day. The shadows (high/low) of the second candlestick do not have to be contained within the first body, though it's preferable if they are.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1019, name: "BEARISH DOWNSIDE GAP THREE METHODS",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "Two long black candlesticks with a downward gap between them appear. They are followed on the third day with a white candlestick, which manages to close the gap between the first two. This should be seen as a support for the downward trend",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. The body of third day candlestick is white and it fills the gap between the first two days").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1020, name: "BLACK MARUBOZU",
                    ...
                    confirmation: ConfirmationTypeEnum.Required,
                    noSticks: 1,
                    definition: "The Black Marubozu is a single candlestick pattern characterized by a long black body. It does not have any shadows on either end. It is an extremely strong bearish candlestick pattern",
                    recognition: "1. A black Marubozu is characterized by not having upper or lower shadows and by its long black body.\n" +
                            ...
                            "3. Then the day closes at its lowest level that explains the absence of the lower shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1021, name: "BULLISH KICKING",
                    ...
                    recognition: "1. Market direction is not important.\n" +
                            ...
                            "3. Then we see a White Marubozu that gaps upward on the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1022, name: "BULLISH MORNING DOJI STAR",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. The white candlestick on the third day confirms the reversal").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1023, name: "BULLISH THREE OUTSIDE UP",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bullish Three Outside Up Pattern is simply another name for the Confirmed Bullish Engulfing Pattern. The third day is confirmation of the bullish trend reversal",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. We see a Bullish Engulfing Pattern in the first two days.\n" +
                            "3. The third day is a white candlestick with a higher close than the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1024, name: "BULLISH CONCEALING BABY SWALLOW",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. Finally we see another Black Marubozu on the fourth day that completely engulfs the candlestick of the third day including the shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1025, name: "BEARISH KICKING",
                    ...
                    noSticks: 2,
                    definition: "A White Marubozu is followed by a sharply lower gap when it opens during the second day. The second day opening is even below the prior session’s opening (forming a Black Marubozu). Such a pattern is called a Bearish Kicking Pattern",
                    recognition: "1. Market direction is not important.\n" +
                            "2. We see a White Marubozu in the first day.\n" +
                            "3. Then we see Black Marubozu day that gaps downward on the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1026, name: "BEARISH EVENING DOJI STAR",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "This is a major top reversal pattern formed by three candlesticks. The first candlestick is a long white body; the second is a doji characterized by a higher gap thus forming a doji star. The third one is a black candlestick with a closing price, which is within the first day’s white real body. It is a meaningful top pattern",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a white candlestick in the first day.\n" +
                            "3. Then we see a Doji that gaps in the direction of the previous uptrend on the second day.\n" +
                            "4. Finally the third day is a black candlestick").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1027, name: "BEARISH THREE INSIDE DOWN",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bearish Three Inside Down Pattern is another name for the Confirmed Bearish Harami Pattern. The third day confirms the bearish trend reversal",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a Bearish Harami Pattern in the first two days.\n" +
                            "3. We then see a black candlestick on the third day with a lower close than the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1028, name: "BEARISH THREE OUTSIDE DOWN",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bearish Three Outside Down Pattern is another name for the Confirmed Bearish Engulfing Pattern. The third day confirms the bearish trend reversal",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a Bearish Engulfing Pattern in the first two days.\n" +
                            "3. Then we see a black candlestick on the third day with a lower close than the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1029, name: "BEARISH UPSIDE GAP TWO CROWS",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bearish Upside Gap Two Crows Pattern is a three-candlestick pattern and it signals a top reversal. The first candlestick is a long white candlestick followed by a real body that gaps higher. Then another black real body appears, which opens above the second day’s open and closes under the second day’s close, completing the pattern",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "5. The close of the second black candlestick is still above the close of the first long white candlestick").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1030, name: "BULLISH THREE INSIDE UP",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bullish Three Inside Up Pattern is another name for the Confirmed Bullish Harami Pattern. The third day is confirmation of the bullish trend reversal",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. We see a Bullish Harami Pattern in the first two days.\n" +
                            "3. Then we see a white candlestick on the third day with a higher close than the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1031, name: "BULLISH DRAGONFLY DOJI",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 1,
                    definition: "The Bullish Dragonfly Doji Pattern is a single candlestick pattern that occurs at the bottom of a trend or during a downtrend. The Bullish Dragonfly Doji Pattern is very similar to the Bullish Hammer Pattern mentioned above. The distinction between the two is if there is a body or not. In case of Bullish Dragonfly Doji Pattern, the opening and closing prices are identical and there is no body. On the other hand the Bullish Hammer Pattern has a small real body at the upper end of the trading range",
                    recognition: "1. There is an overall downtrend in the market.\n" +
                            ...
                            "4. However the doji does not have any upper shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1032, name: "BULLISH HARAMI CROSS",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. Then we see a long black candlestick.\n" +
                            "3. Long black candlestick is followed by a doji completely engulfed by the real body of the first day. The shadows (high/low) of the doji may not be necessarily contained within the first black body, though it's preferable if they are").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1033, name: "BULLISH HOMING PIGEON",
                    ...
                    recognition: "1. Market is in downtrend.\n" +
                            ...
                            "3. Then we again see a black body in the second day where the real body of this second day is completely engulfed by the real body of the first day. It is not required that the shadows (high/low) of the second candlestick are contained within the first, though it's preferable if they are").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1034, name: "BULLISH MATCHING LOW",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 2,
                    definition: "Bullish Matching Low Pattern occurs when two black days appear with equal closes in a downtrend. The pattern is suggestive of a short-term support, and it may cause a reversal on the next day of trading",
                    recognition: "1. The market moves in downtrend.\n" +
                            "2. We then see a long black candlestick on the first day.\n" +
                            "3. Second day follows with another black candlestick whose closing price is equal or extremely close to the closing price of the first day.").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1036, name: "BULLISH STICK SANDWICH",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bullish Stick Sandwich Pattern is characterized by consecutive higher opens for three days, but results in an eventual close equal to the first day's close. It may warn that prices are now finding a support price. We may then see a reversal from this support level",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. Then we again see a Black Closing Marubozu characterized with a close equal to the close of the first day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1037, name: "BULLISH THREE STAR IN THE SOUTH",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "We see three consecutive black candlesticks during a downtrend. These candlesticks show that each day is consecutively weaker in a bearish sense and possibly some buying is occurring. Daily small rallies keep the market’s lows from reaching that of the first day. These indications suggest that tide is turning in a bullish direction",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. We finally see a small Black Marubozu on the third day that lies within the second day’s trading range").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1038, name: "BULLISH TRI STAR",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bullish Tri Star Pattern is a very rare but significant bottom reversal pattern. Three Dojis form this pattern. The middle Doji is a Doji Star",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. Then we see three consecutive Doji.\n" +
                            "3. The second day Doji gaps below the first and third").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1039, name: "BULLISH UNIQUE THREE RIVER BOTTOM",
                    ...
                    recognition: "1. Market is characterized by a downtrend.\n" +
                            ...
                            "5. Then we see a short white candlestick, which is below the second day candlestick").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1040, name: "BULLISH BREAKAWAY",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. Bearish mood continues on the third and fourth days as evidenced by lower consecutive closes").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1041, name: "BULLISH LADDER BOTTOM",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. Finally we see a white candlestick opening above the body of the fourth day on the fifth day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1042, name: "BULLISH BELT HOLD",
                    ...
                    confirmation: ConfirmationTypeEnum.Required,
                    noSticks: 1,
                    definition: "The Bullish Belt Hold Pattern is a single candlestick pattern. It is basically a White Opening Marubozu that occurs in a downtrend. As such; it opens on its low, then we see a rally during the day against the overall trend of the market, and then the day closes near its high but not necessarily at its high. If Belt Hold lines are characterized by longer bodies, then it means that they offer more resistance to the trend they are countering",
                    recognition: "1. There must be an overall downtrend in the market.\n" +
                            ...
                            "3. We see a white body that has no lower shadow that is a White Opening Marubozu").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1043, name: "BULLISH SIDE-BY-SIDE WHITE LINES",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "A white candlestick with an upward gap over another white candlestick is followed in the next day by another similar sized white candlestick. The second and the third days have the same opening price. Such a formation is called a Bullish Side By Side White Lines Pattern",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a white candlestick in the first day.\n" +
                            "3. Then we see another white candlestick on the second day with an upward gap.\n" +
                            "4. Finally, we see a white candlestick on the third day characterized by the same body length and whose closing price is equal to the close of the second day and a new high is established").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1044, name: "BULLISH MAT HOLD",
                    ...
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "5. Finally we see a white candlestick, which opens with a gap and closes with a new high on the fifth day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1045, name: "BULLISH RISING THREE METHODS",
                    ...
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "4. Finally we see a long white candlestick on the fifth day opening above the close of the previous day and also closing at a new high").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1048, name: "BULLISH SEPERATING LINES",
                    ...
                    confirmation: ConfirmationTypeEnum.Required,
                    noSticks: 2,
                    definition: "It is a White Opening Marubozu following a black body. During an uptrend, after we see a black candlestick in the first day, the market gaps up sharply higher when it opens with an opening price equal to the prior session’s opening and it also closes the day at a higher level",
                    recognition: "1. Market is characterized by an uptrend.\n" +
                            "2. We see a long black candlestick in the first day.\n" +
                            "3. Then we see that the second day has the same opening price as the first day, or extremely close to it.\n" +
                            "4. The second day pattern is a White Opening Marubozu").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1049, name: "BULLISH THREE LINE STRIKE",
                    ...
                    confirmation: ConfirmationTypeEnum.DefinitelyRequired,
                    noSticks: 4,
                    definition: "This pattern is formed by three adjacent white long candlesticks followed by a black candlestick driving prices back to the point where they were at the beginning of the pattern. If there was a strong bullish trend before the pattern, then it should continue",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see three consecutive long white candlesticks with consecutively higher closes.\n" +
                            "3. Then we see a black candlestick opening at a higher level and closing below the open of the pattern’s first day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1050, name: "BEARISH DRAGONFLY DOJI",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 1,
                    definition: "A Bearish Dragonfly Doji Pattern is a single candlestick pattern, which occurs at a market top or during an uptrend. The Bearish Dragonfly Doji Pattern is very similar to the Bearish Hanging Man Pattern as mentioned above. In the case of Bearish Dragonfly Doji Pattern, the opening and closing prices are identical whereas the Bearish Hanging Man Pattern is characterized by a small real body at the upper end of the trading range",
                    recognition: "1. The market is characterized by an overall uptrend.\n" +
                            ...
                            "4. There is no upper shadow").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1051, name: "BEARISH HARAMI CROSS",
                    ...
                    confirmation: ConfirmationTypeEnum.Recommended,
                    noSticks: 2,
                    definition: "Bearish Harami Cross Pattern is a doji preceded by a long white real body. The Bearish Harami Cross Pattern is a major reversal pattern and is more significant than a regular Bearish Harami Pattern",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a long white candlestick in the first day.\n" +
                            "3. Then we see a doji completely engulfed by the real body of the first day on the second day. The shadows (high/low) of this Doji do not have to be contained within the first, though it's preferable if they are").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1052, name: "BEARISH MEETING LINES",
                    ...
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "5. Both of the candlesticks are long but second day candlestick may be shorter than the first").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1053, name: "BEARISH ADVANCE BLOCK",
                    ...
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "4. Each day’s body is significantly smaller than the body of the previous day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1054, name: "BEARISH DELIBERATION",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bearish Deliberation Pattern is a derivative of the Bearish Three White Soldiers Pattern. This pattern also shows a weakness similar to the Bearish Advance Block Pattern since it becomes weaker in a short period of time. However here the weakness occurs all at once on the third day. The small third body of the pattern shows that the rally is losing strength and a reversal is possible",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            ...
                            "5. The third day is typically a short white candlestick, a spinning top or a star that gaps above the second day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1055, name: "BEARISH TRI STAR",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "The Bearish Tri Star Pattern is a very rare but significant top reversal pattern. It is formed by three Dojis. The middle Doji is a Doji Star",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see three Dojis on three consecutive days.\n" +
                            "3. The second day Doji has a gap above the first and third").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1056, name: "BEARISH TWO CROWS",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 3,
                    definition: "During an uptrend we see the market closing lower after an opening gap. Then we see a black day that fills the gap creating the Bearish Two Crows Pattern. It suggests the erosion of the uptrend, and warns about a possible trend reversal",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a long white candlestick in the first day.\n" +
                            "3. Then we see a black candlestick on the second day characterized by a gap up.\n" +
                            "4. Finally we see a black candlestick whose opening price is inside the body of the second day and which closes inside the body of the first day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1057, name: "BEARISH BREAKAWAY",
                    ...
                    confirmation: ConfirmationTypeEnum.Recommended,
                    noSticks: 5,
                    definition: "We see this pattern during an uptrend marked with a bullish surge that eventually weakens. This weakening is illustrated by a long black candlestick that is unable to close the gap into the body of the first day. These events warn us about a short-term reversal",
                    recognition: "1. Market is characterized by uptrend.\n" +
                            "2. We see a long white candlestick in the first day.\n" +
                            ...
                            "5. Finally we see a long black candlestick on the fifth day with a closing price inside the gap caused by the first and second days").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1058, name: "BEARISH BELT HOLD",
                    ...
                    confirmation: ConfirmationTypeEnum.Required,
                    noSticks: 1,
                    definition: "The Bearish Belt Hold Pattern is a single candlestick pattern and it is basically a Black Opening Marubozu that occurs in an uptrend. The pattern shows that the day opens on its high, it then rallies against the trend of the market, and then closes near its low but not necessarily at its low. Longer bodies for Belt Hold are indicative of more resistance to the trend they are countering",
                    recognition: "1. There is an overall uptrend in the market.\n" +
                            ...
                            "3. We then see a black body characterized by the absence of upper shadow, which is called a Black Opening Marubozu").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1059, name: "BEARISH FALLING THREE METHODS",
                    ...
                    recognition: "1. Market is characterized by downtrend.\n" +
                            ...
                            "4. Finally we see a long black candlestick on the fifth day opening near the previous day’s close and also closing below the close of the initial day to define a new low").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1060, name: "BEARISH IN NECK",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 2,
                    definition: "Bearish In Neck Pattern is characterized by a white candlestick that has a closing price slightly above the previous black candlestick’s low during a downtrend. If the white candlestick’s low is broken down, the downtrend continues",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. We see a long black candlestick in the first day.\n" +
                            "3. Then we see a white candlestick on the second day with an opening price that is below the low of the previous day and whose closing price is barely above or equal to the closing price of the previous day").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1061, name: "BEARISH ON NECK",
                    ...
                    confirmation: ConfirmationTypeEnum.Suggested,
                    noSticks: 2,
                    definition: "Bearish On Neck Pattern is a black candlestick followed by a small white candlestick, which is characterized by a closing price near the low of the black candlestick during a downtrend. If the low of white candlestick is broken down, market goes further down",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. We see a long black candlestick in the first day.\n" +
                            ...
                            "4. The closing price of the second day is either the low price of the first day or almost same").save(flush: true, insert: true, failOnError: true)
            ...
            new Pattern(code: 1062, name: "BEARISH DOWNSIDE TASUKI GAP",
                    ...
                    confirmation: ConfirmationTypeEnum.Recommended,
                    noSticks: 3,
                    definition: "The pattern involves two long black candlesticks with a downward gap between them during a downtrend. Pattern is completed by a third day white candlestick partially closing the gap between the first two. The white candlestick may be the result of investors temporarily taking advantage of the low buying price. However we expect the trend to continue in the downward direction",
                    recognition: "1. Market is characterized by downtrend.\n" +
                            "2. We see two long black candlesticks with a gap between them in the first and second days.\n" +
