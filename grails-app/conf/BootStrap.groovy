...
//
            new Stock("AAPL", "Apple Computers").save(flush: true)
            new Stock("IBM", "International Business Machines").save(flush: true)
            new Stock("SSRI", "Silver Standard Resources").save(flush: true)
