...
<script class="code" language="javascript" type="text/javascript">
    $(document).ready(function () {
        var plot2 = $.jqplot('chart2-${StockUtils.lastDate(stockInstance)}',
                [   normalized${StockUtils.lastDate(stockInstance)},
                    bbl${StockUtils.lastDate(stockInstance)},
                    bbup${StockUtils.lastDate(stockInstance)},
    ...
    bbup${StockUtils.lastDate(stockInstance)} = ${stockInstance.indicators.get("bbup").jqPlot};
