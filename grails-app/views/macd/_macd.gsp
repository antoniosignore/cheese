...
<script class="code" language="javascript" type="text/javascript">
    $(document).ready(function () {
        var plot2 = $.jqplot('chart2-${StockUtils.lastDate(stockInstance)}',
                [   normalized${StockUtils.lastDate(stockInstance)},
                    macd${StockUtils.lastDate(stockInstance)},
                    macdsignal${StockUtils.lastDate(stockInstance)}], {
    ...
    macd${StockUtils.lastDate(stockInstance)} = ${stockInstance.indicators.get("macd").jqPlot};
    macdsignal${StockUtils.lastDate(stockInstance)} = ${stockInstance.indicators.get("macdsignal").jqPlot};
