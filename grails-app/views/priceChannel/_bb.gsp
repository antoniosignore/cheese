...
<script class="code" language="javascript" type="text/javascript">
    $(document).ready(function () {
        var plot2 = $.jqplot('chart2-${StockUtils.lastDate(stockInstance)}',
                [   normalized${StockUtils.lastDate(stockInstance)},
                    pcl${StockUtils.lastDate(stockInstance)},
                    pcu${StockUtils.lastDate(stockInstance)}], {
    ...
    pcl${StockUtils.lastDate(stockInstance)} = ${stockInstance.indicators.get("pcl").jqPlot};
    pcu${StockUtils.lastDate(stockInstance)} = ${stockInstance.indicators.get("pcu").jqPlot};
